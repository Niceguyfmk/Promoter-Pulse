...
export function ActivityPeriodDropdown({
  currentPeriod
}: {
  currentPeriod: ActivitySummaryPeriod;
}) {
  ...
  return (
    <div className="activity-feed">
      <select
        className="h-14 min-w-[220px] rounded-lg bg-ink pl-6 text-base font-semibold text-white shadow-lg shadow-black/10 outline-none"
